...
public partial class FormParent : Form
{
    ...
    */
    ...
    {
        InitializeComponent();
        statusStrip.Renderer = new StatusBar_Renderer();
    }
    ...
    */
    ...
    private void FormParent_Load(object sender, EventArgs e)
    {
        ...
        toolStripStatusLabel1.Text = @"Press Generate to create serial number ...";
        statusStrip.Refresh();

        /*
            combo > editions > populate
        */
        cboEditions.Items.AddRange(Environment.GetEnvironmentVariable("editions_list")?.Split(","));

        /*
            combo > editions > default
        */

        var v_def_edition = ConfigurationManager.AppSettings["edition_default"];
        ...
        */
        ...
        var def_users = ConfigurationManager.AppSettings["users_min_default"];
    ...
    */
    ...
    private void btn_Window_Minimize_Click(object sender, EventArgs e) => WindowState = FormWindowState.Minimized;

    /*
        Window > Button > Minimize > Mouse Enter
    */

    private void btn_Window_Minimize_MouseEnter(object sender, EventArgs e) => minimizeBtn.ForeColor = Color.FromArgb(222, 31, 100);

    /*
        Window > Button > Minimize > Mouse Leave
    */

    private void btn_Window_Minimize_MouseLeave(object sender, EventArgs e) => minimizeBtn.ForeColor = Color.FromArgb(255, 255, 255);

    /*
        Window > Button > Close > Click
    */

    private void btn_Window_Close_Click(object sender, EventArgs e) => Application.Exit();
    ...
    */
    ...
    {
        var usersInput = txtUsers.Text;
        serialTextbox.Text         = serial.Generate();
        toolStripStatusLabel1.Text = @"Serial number generated. Paste into .NET Reflector app.";
        statusStrip.Refresh();
    ...
    */
    ...
    private void btn_Copy_Click(object sender, EventArgs e)
    {
        ...
        {
            toolStripStatusLabel1.Text = @"Generate serial number first";
            statusStrip.Refresh();
        }
        else
        {
            ...
            toolStripStatusLabel1.Text = @"Serial number copied. Paste in Reflector app.";
            statusStrip.Refresh();
        }
    }
    ...
    */
    ...
    {
        // border color
        var p = new Pen(Color.FromArgb(75, 75, 75));
    ...
    */
    ...
    private void txt_Request_TextChanged(object sender, EventArgs e)
    {
        ...
        try
        {
            var sel_edition = cboEditions.Text;
            var sel_users   = txtUsers.Text;
    ...
    */
    ...
    {
        var i_min_users = int.Parse(Environment.GetEnvironmentVariable("users_min_default"));
        var i_max_users = int.Parse(Environment.GetEnvironmentVariable("users_max_default"));

        // limit input to numbers only
        if (Regex.IsMatch(txtUsers.Text, "[^1-9]"))
        {
            MessageBox.Show($@"Numbers are 1, 2, 3, - {i_max_users}", @"Not a valid number", MessageBoxButtons.OK, MessageBoxIcon.Error);
    ...
    */
    ...
    private void btn_Response_Copy_Click(object? sender, EventArgs e)
    {
        ...
        {
            toolStripStatusLabel1.Text = @"Cannot paste an empty clipboard";
        ...
        else
        {
            ...
            toolStripStatusLabel1.Text = @"Response copied. Go back to .NET Reflector and paste what you copied into the right-side box.";
            statusStrip.Refresh();
        }
    }
    ...
    */
    ...
    private void btn_Request_Load_Click(object? sender, EventArgs e)
    {
        ...
        {
            var sr = File.OpenText(dlg.FileName);
            ...
            toolStripStatusLabel1.Text = $@"Loaded Activation Request from {dlg.FileName}";
            statusStrip.Refresh();
        }
    }
    ...
    private void btn_Response_Save_Click(object? sender, EventArgs e)
    {
        if (!string.IsNullOrEmpty(requestTextbox.Text))
        {
            ...
            if (dlg.ShowDialog() == DialogResult.OK)
                ...
                {
                    foreach (var line in requestTextbox.Lines)
                        sw.WriteLine(line);
                    ...
                    toolStripStatusLabel1.Text = $@"Saved generation response {file_path}";
                    statusStrip.Refresh();
                }
        }
        else
    ...
    */
    ...
    public class StatusBar_Renderer() : ToolStripProfessionalRenderer(new ClrTable())
    {
